...
#include "PhysXPlaneComponent.h"

#include <GameEngineCore/GameEngineFBXMesh.h>

PhysXPlaneComponent::PhysXPlaneComponent()
{
}
...
void PhysXPlaneComponent::CreatePhysXActors(physx::PxScene* _Scene, physx::PxPhysics* _physics,
	physx::PxCooking* _cooking, bool _InverseIndex, physx::PxVec3 _GeoMetryScale, float4 _GeoMetryRot)
{
	...
	physx::PxPlaneGeometry Plane = physx::PxPlaneGeometry();

		//createExclusiveShapefh RigidStatic에 Shape를 넣어준다.
		m_pShape = physx::PxRigidActorExt::createExclusiveShape(*m_pRigidStatic, Plane, *m_pMaterial);
		//피벗 설정
...
void PhysXPlaneComponent::Start()
{
	// 부모의 정보의 저장
	ParentActor = GetActor()->DynamicThis<GameEngineActor>();
}

void PhysXPlaneComponent::Update(float _DeltaTime)
{
...
void PhysXPlaneComponent::CustomFBXLoad(const std::string& _MeshName, bool _InverseIndex)
{
