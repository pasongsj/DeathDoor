...
#define PHYSXSCALE_BRUTE			float4{0.0f, 300.0f, 120.0f}

#define RENDERSCALE_BRUTEGOLD		30.0f
#define PHYSXSCALE_BRUTEGOLD		float4{0.0f, 300.0f, 120.0f}

#define RENDERSCALE_FIREPLANT		120.0f
#define PHYSXSCALE_FIREPLANT		float4{0.0f, 300.0f, 120.0f}
...
#define PHYSXSCALE_GHOUL			float4{0.0f, 300.0f, 120.0f}

#define RENDERSCALE_GHOUL_RAPID		150.0f
#define PHYSXSCALE_GHOUL_RAPID		float4{0.0f, 300.0f, 120.0f}

#define RENDERSCALE_GRUNT			25.0f
#define PHYSXSCALE_GRUNT			float4{0.0f, 300.0f, 60.0f}

#define RENDERSCALE_MAGE			50.0f
#define PHYSXSCALE_MAGE				float4{0.0f, 300.0f, 80.0f}

#define RENDERSCALE_JUMPER			60.0f
#define PHYSXSCALE_JUMPER			float4{0.0f, 300.0f, 200.0f}
