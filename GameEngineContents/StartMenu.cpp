...
void StartMenu::Set_MenuButton()
{
	...
	StartButton->TextShadow->SetFont("¸¼Àº °íµñ");
	StartButton->TextShadow->SetText("½ÃÀÛ");
	...
	StartButton->Text->SetFont("¸¼Àº °íµñ");
	StartButton->Text->SetText("½ÃÀÛ");
	...
	ExitButton->TextShadow->SetFont("¸¼Àº °íµñ");
	ExitButton->TextShadow->SetText("Á¾·á");
	...
	ExitButton->Text->SetFont("¸¼Àº °íµñ");
	ExitButton->Text->SetText("Á¾·á");
...
void StartMenu::SelectMenu()
{
	...
	{
		//¸¶¿ì½º¿Í Ãæµ¹ÇÏ¸é ÇØ´ç ¹öÆ°ÀÇ ColEvent ½ÇÇà
	}
}
