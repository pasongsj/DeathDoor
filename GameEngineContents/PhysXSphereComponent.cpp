...
PhysXShpereComponent::PhysXShpereComponent()
{
}
...
physx::PxRigidDynamic* PhysXShpereComponent::CreatePhysXActors(physx::PxScene* _Scene, physx::PxPhysics* _physics, physx::PxVec3 _GeoMetryScale, float4 _GeoMetryRotation)
{
	m_pScene = _Scene;
	m_pPhysics = _physics;
	...
	m_pShape = physx::PxRigidActorExt::createExclusiveShape(*m_pRigidDynamic, physx::PxCapsuleGeometry(ScaledRadius * 1.f, ScaledHeight * 1.f), *m_pMaterial);
...
void PhysXShpereComponent::SetMoveSpeed(float4 _MoveSpeed)
{
	...
	// 캐릭터의 방향을 힘으로 조절
	m_pRigidDynamic->addForce(physx::PxVec3(_MoveSpeed.x, _MoveSpeed.y, _MoveSpeed.z), physx::PxForceMode::eFORCE);
}

void PhysXShpereComponent::SetMoveJump()
{
	m_pRigidDynamic->addForce(physx::PxVec3(0.0f, PLAYER_JUMP_FORCE, 0.0f), physx::PxForceMode::eIMPULSE);
}

void PhysXShpereComponent::SetMoveDive(float _Rot)
{
...
void PhysXShpereComponent::SetDynamicIdle()
{
	// 고정된 축을 해제
...
void PhysXShpereComponent::Start()
{
	// 부모의 정보의 저장
	ParentActor = GetActor()->DynamicThis<GameEngineActor>();
}

void PhysXShpereComponent::Update(float _DeltaTime)
{
...
void PhysXShpereComponent::PushImpulse(float4 _ImpulsePower)
{
	// 고정된 축을 해제
	m_pRigidDynamic->setRigidDynamicLockFlag(physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_X, false);
	m_pRigidDynamic->setRigidDynamicLockFlag(physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_Y, false);
...
void PhysXShpereComponent::PushImpulseAtLocalPos(float4 _ImpulsePower, float4 _Pos)
{
	// 고정된 축을 해제
	m_pRigidDynamic->setRigidDynamicLockFlag(physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_X, false);
	m_pRigidDynamic->setRigidDynamicLockFlag(physx::PxRigidDynamicLockFlag::eLOCK_ANGULAR_Z, false);
...
void PhysXShpereComponent::SpeedLimit()
{
...
void PhysXShpereComponent::SetChangedRot(float4 _Rot)
{
...
//플레이어 멈추는 함수
void PhysXShpereComponent::FreezeDynamic()
{
	m_pRigidDynamic->putToSleep();
}

void PhysXShpereComponent::WakeUpDynamic()
{
	m_pRigidDynamic->wakeUp();
}

void PhysXShpereComponent::ResetDynamic()
{
