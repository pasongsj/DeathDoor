...
void Player::InitPlayerAnimatioin()
{
	...
	//attack
		//left btn
	Renderer->CreateFBXAnimation("Slash_Light_L_new", "Slash_Light_R_new.FBX", { 0.01f,false }); // 일반 좌클릭
	AnimationName.push_back("Slash_Light_L_new");

	Renderer->CreateFBXAnimation("Slash_Light_R_new", "Slash_Light_L_new.FBX", { 0.01f,false }); // 일반 좌클릭
