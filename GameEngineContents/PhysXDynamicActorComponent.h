...
public:
	...
	physx::PxRigidDynamic* CreatePhysXActors(physx::PxVec3 _GeoMetryScale = physx::PxVec3(2.0f), float4 _GeoMetryRot = { 0.0f , 0.0f });
	...
	void SetMainPlayerFlags()
	{
		...
		m_pInstshape->setSimulationFilterData(physx::PxFilterData(static_cast<physx::PxU32>(PhysXFilterGroup::PlayerDynamic), 0, 0, 0));
	}
protected:
	void Start() override;
